...
export const GridPromptPreview = ({ prompt }: GridPromptPreviewProps) => (
  <div className="w-[300px] shrink-0 flex flex-col border-l border-(--border-faint) bg-(--bg-sidebar)">
    ...
    <div className="flex-1 overflow-y-auto p-4 min-h-0">
      {prompt ? (
        <pre className="text-[11px] font-['Fira_Code',monospace] text-(--text-secondary) leading-relaxed m-0 whitespace-pre-wrap break-words">
          {prompt}
        </pre>
      ) : (
